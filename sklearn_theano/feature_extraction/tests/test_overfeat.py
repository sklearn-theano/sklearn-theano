...
@mem.cache
def get_theano_output(input_img, layer, largenet):
    fprop = _get_fprop(largenet, output_layers=[layer])
...
def _check_overfeat_layer(input_img, theano_layer, binary_layer,
    ...
    assert_array_almost_equal(theano_output, binary_output, decimal=4)
...
def test_theano_overfeat_against_binary():
    layer_correspondence = dict(
        large=[(0, 0, None), (1, 2, None), (2, 3, None), (3, 5, None),
               ...
               (8, 18, None), (9, 19, None), (10, 21, None), (11, 23, None),
               (12, 24, None)],
        small=[(0, 0, None), (1, 2, None), (2, 3, None), (3, 5, None),
               (4, 6, None), (5, 9, None),
               (6, 12, None),
               (7, 15, None), (8, 16, None), (9, 18, None), (10, 20, None),
               (11, 21, None)])
